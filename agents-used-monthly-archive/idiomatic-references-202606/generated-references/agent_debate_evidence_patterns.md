...
Primary user starting state: The user has a `agent_debate_evidence_patterns` task, one or more local source paths, and uncertainty about which pattern should drive implementation.
Decision being made: choosing what context to load, what to offload, when to delegate, and how to prove completion.
Reference opening trigger: Open this file when the task mentions agent debate evidence patterns, any mapped local source path, or an adjacent workflow with the same failure mode.

## Decision Tradeoff Guide

| decision_option_name | when_to_choose_condition | tradeoff_cost_description | verification_question_prompt |
| --- | --- | --- | --- |
| Adopt when | local corpus and external evidence agree on the agent debate evidence patterns pattern | fastest path, but can copy stale local assumptions | Does the selected pattern appear in the canonical source and current external evidence? |
| Adapt when | local sources are strong but public ecosystem guidance has changed | preserves repo fit, but requires explicit inference notes | Did the reference label the local fact, external fact, and combined inference separately? |
| Avoid when | source evidence is thin, conflicting, or unrelated to the user journey | prevents false confidence, but may require deeper research | Is there a confidence warning or adjacent reference route? |
| Cost of being wrong | wrong agent debate evidence patterns guidance can send an agent to the wrong files, tests, or abstraction | wasted implementation loop and weaker verification | Would a reviewer know what to undo and what to inspect next? |
...
| --- | --- | --- | --- |
| agents-used-monthly-archive/codex-skills-202602/agent-debate-01/SKILL.md | canonical primary source | Agent Debate 01; When To Debate; Workflow | What guidance, warning, or example should this source contribute to Agent Debate Evidence Patterns? |
| agents-used-monthly-archive/codex-skills-202602/agent-debate-01/references/debate-template-and-tag-rules.md | supporting detail source | Debate Template and Tag Rules; Required Sections; Debate: {TOPIC} | What guidance, warning, or example should this source contribute to Agent Debate Evidence Patterns? |
| agents-used-monthly-archive/codex-skills-202602/agent-debate-01/references/evidence-and-convergence-guardrails.md | supporting detail source | Evidence and Convergence Guardrails; Evidence Standard; Simplicity Rules | What guidance, warning, or example should this source contribute to Agent Debate Evidence Patterns? |
| agents-used-monthly-archive/codex-skills-202602/agent-debate-01/references/repo-workflow-notes.md | supporting detail source | Repo Workflow Notes; Core Model; Typical Debate Prompts | What guidance, warning, or example should this source contribute to Agent Debate Evidence Patterns? |
| agents-used-monthly-archive/codex-skills-202603/agent-debate-01/SKILL.md | legacy historical source | Agent Debate 01; When To Debate; Workflow | What guidance, warning, or example should this source contribute to Agent Debate Evidence Patterns? |
| agents-used-monthly-archive/codex-skills-202603/agent-debate-01/references/debate-template-and-tag-rules.md | supporting detail source | Debate Template and Tag Rules; Required Sections; Debate: {TOPIC} | What guidance, warning, or example should this source contribute to Agent Debate Evidence Patterns? |
| agents-used-monthly-archive/codex-skills-202603/agent-debate-01/references/evidence-and-convergence-guardrails.md | supporting detail source | Evidence and Convergence Guardrails; Evidence Standard; Simplicity Rules | What guidance, warning, or example should this source contribute to Agent Debate Evidence Patterns? |
| agents-used-monthly-archive/codex-skills-202603/agent-debate-01/references/repo-workflow-notes.md | supporting detail source | Repo Workflow Notes; Core Model; Typical Debate Prompts | What guidance, warning, or example should this source contribute to Agent Debate Evidence Patterns? |

## Theme Specific Artifact

Theme specific artifact: debate rubric with convergence criteria, dissent handling, and evidence thresholds.

| artifact_field_name | artifact_completion_rule | evidence_source_hint |
| --- | --- | --- |
| user_goal_statement | state the user's concrete goal before applying Agent Debate Evidence Patterns | local corpus hierarchy plus critique findings |
| decision_boundary_rule | define the point where this reference should be used or avoided | decision tradeoff guide |
| verification_gate_rule | define the command, checklist, or review question that proves the artifact worked | verification gate command set |

## Worked Example Set

Good example: Use Agent Debate Evidence Patterns after loading the canonical source, confirming the external evidence boundary, and writing a verification gate before implementation.
Bad example: Use Agent Debate Evidence Patterns as a generic tutorial while ignoring the mapped local paths, source hierarchy, and cost of being wrong.
Borderline case: Use Agent Debate Evidence Patterns only after adding a confidence warning when local evidence is thin or conflicts with current ecosystem guidance.
...
- The role scenario names the user, starting state, decision, and trigger for Agent Debate Evidence Patterns.
...
Adjacent reference 1: consider the agent adjacent reference when the current task pivots away from agent debate evidence patterns.
Adjacent reference 2: consider the debate adjacent reference when the current task pivots away from agent debate evidence patterns.
Adjacent reference 3: consider the evidence adjacent reference when the current task pivots away from agent debate evidence patterns.

## Workload Model

`combined_evidence_inference_note`: Treat Agent Debate Evidence Patterns as a agent workflow operating reference, not as a prose summary.
...
| artifact_pressure_model | required artifact is debate rubric with convergence criteria, dissent handling, and evidence thresholds | require the artifact before claiming the reference is operationally usable |
...
Agent Debate Evidence Patterns stops being sufficient when the task spans multiple independent systems, more than one ownership boundary, unbounded source discovery, or production traffic without an explicit SLO.
