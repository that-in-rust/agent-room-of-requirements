...
| # | Principle | ELI10 | Mathematical Basis |
|---|-----------|-------|-------------------|
| 1 | LLMs are Search Engines | Librarian, not scientist | Information retrieval, not reasoning |
| 2 | Iteration Required | Draw → Refine → Refine → Done | Optimization converges over iterations |
| 3 | Context Forgets | Take notes for forgetful friend | Attention decay is exponential |
| 4 | Self-Critique | Be your own devil's advocate | Ensemble learning surfaces errors |
| 5 | Negative > Positive | "Don't" eliminates more than "Do" shows | Constraint satisfaction theory |
| 6 | Tests = Specs | Measurements, not descriptions | Extensional > intensional definition |
| 7 | 4 Words Optimal | Specific but not overwhelming | Token-attention tradeoff peaks at 4 |
| 8 | Match Process to Work | Right tool for right job | Cost-of-error optimization |
| 9 | PRD-ARCH Co-Evolve | Design informs requirements | Bi-level optimization |
| 10 | State Serialization | Take pictures of progress | Checkpointing for continuity |
| 11 | Explicit Delegation | Rules, not vibes | Decision boundary prevents drift |
| 12 | Feedback Closes Loop | Watch and learn | Control theory convergence |
